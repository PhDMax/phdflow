...
1. Download **PhDFlow Setup 0.24.1.exe** from the [latest release](../../releases/latest) and run it
...
### Portable version
**PhDFlow-Portable-0.24.1.exe** — runs without installing, useful for USB drives or restricted machines.
...
### v0.24.1
- feat: utilities +1 views, app shell, scripts, config
...
- chore: bump to v0.23.4
- chore: session updates
- fix: support webcal:// calendar subscription URLs in ICS sync
- chore: bump to v0.23.3
- feat: dashboard +1 views, app shell
- chore: bump to v0.23.2
- feat: dashboard
