...
1. Download **PhDFlow Setup 0.23.1.exe** from the [latest release](../../releases/latest) and run it
...
### Portable version
**PhDFlow-Portable-0.23.1.exe** — runs without installing, useful for USB drives or restricted machines.
